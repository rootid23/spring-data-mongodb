...
public class ReactiveExecutableInsertOperationSupportUnitTests {

	private static final String STAR_WARS = "star-wars";

	@Mock ReactiveMongoTemplate template;

	ReactiveExecutableInsertOperationSupport ops;
	...
	public void setUp() {
		...
		ops = new ReactiveExecutableInsertOperationSupport(template);
